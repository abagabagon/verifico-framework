...
public class Listener extends Tests implements ITestListener{
	...
	public void onTestSuccess(ITestResult arg0) {
		String testCaseId = arg0.getMethod().getMethodName();
		if (bulkUpdate == false) {
			testManagement.setTestAsPassed(testCaseId);
		}
	...
	public void onTestFailure(ITestResult arg0) {
		String testCaseId = arg0.getMethod().getMethodName();
		if (bulkUpdate == false) {
			testManagement.setTestAsFailed(testCaseId);
		}
	...
	public void onTestSkipped(ITestResult arg0) {
		String testCaseId = arg0.getMethod().getMethodName();
		if (bulkUpdate == false) {
			testManagement.setTestAsSkipped(testCaseId);
		}
	...
	public void onFinish(ITestContext arg0) {
		...
		if(bulkUpdate == true) {
			testManagement.setTestsAsPassed(passedTests);
			testManagement.setTestsAsFailed(failedTests);
			testManagement.setTestsAsSkipped(skippedTests);
		}
	}
